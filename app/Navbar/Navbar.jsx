  ...
  return (
    <>
      ...
      <div
        ...
        } transition-all duration-300 ease-in-out  bg-sky-900/70 shadow-md backdrop-blur-lg fixed h-full end-0 w-[300px] z-50 flex overflow-hidden  `}
      >
        ...
        <button
          onClick={handleOpen}
          className="cursor-pointer absolute end-6 top-7"
        >
